...
def pcmci_graph_robustness_bootstrap(DATA: pd.DataFrame, cond_ind_test: str, tau_min: int, tau_max: int, alpha_list: list, alpha_level: float, mask_threshold: float, boot_samples: int) -> None:
    """
    Perform PCMCI graph robustness bootstrap analysis varying the alpha PC parameter.
    ...
    alpha_list (list): List of alpha values for PC algorithm.
